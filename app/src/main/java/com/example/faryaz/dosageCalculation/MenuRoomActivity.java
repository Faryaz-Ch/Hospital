...
public class MenuRoomActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v){
     Intent i;
        ...
        switch (v.getId()){
            case R.id.viewCard :
                i = new Intent(this, ListRoomActivity.class);
                startActivity(i);
                break;
            case R.id.addCard :
                i = new Intent(this, NewRoomActivity.class);
                startActivity(i);
                break;
            default: break;
        }
