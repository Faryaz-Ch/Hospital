...
public class AdminDashboardActivity extends AppCompatActivity implements android.view.View.OnClickListener{
    CardView drugCard, nurseCard, patientCard, roomCard, addPatientCard, addStaffCard;
    TextView txtWelcome;
